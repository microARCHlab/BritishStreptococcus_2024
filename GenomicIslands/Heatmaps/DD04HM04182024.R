...
# Read in data
# Coverage summary
rawdata <- read.delim("~/Desktop/GenomicIslands/ByWhole/Streptococcus_spDD04_GenomicIslandCoverageSummary.txt", header = TRUE, check.names = FALSE)
#rawdata <- read.delim("~/Desktop/GenomicIslands/ByWhole/Streptococcus_sanguinis_GenomicIslandCoverageSummary_Combined.txt", header = TRUE, check.names = FALSE)
# Island attributes
rawislanddata <- read.delim("~/Desktop/GenomicIslands/ByWhole/Streptococcus_spDD04_GenomicIslandAttributes.txt", header = TRUE, check.names = FALSE)
#rawislanddata <- read.delim("~/Desktop/GenomicIslands/ByWhole/Streptococcus_sanguinis_GenomicIslandAttributes.txt", header = TRUE, check.names = FALSE)
# Sample attributes
rawsampledata <- read.delim("~/Desktop/GenomicIslands/ByWhole/Streptococcus_spDD04_SampleAttributes.txt", header = TRUE, check.names = FALSE)
#rawsampledata <- read.delim("~/Desktop/GenomicIslands/ByWhole/Streptococcus_sanguinis_SampleAttributes_Combined.txt", header = TRUE, check.names = FALSE)
# Island characterization (made after filtered islands)
islandcharacterization <- read.delim("~/Desktop/GenomicIslands/ByWhole/04182024-DD04Characterization.txt", header = TRUE, check.names = FALSE)
...
# Select the island coverage data for these samples
...
Heatmap <- ComplexHeatmap::Heatmap(
  ...
  column_title = "Streptococcus sinensis Genomic Islands",
...
# Add in row number values in the sorted frame; export for later reference
...
write_tsv(selectedislandcharacterization_rowlabels, "~/Desktop/GenomicIslands/ByWhole/DD04-04162024-sortedontologies.tsv")
...
# Make sure input order matches again with these new labels
...
pdf("~/Desktop/GenomicIslands/ByWhole/DD04-04162024.pdf", width = 11, height = 8)
draw(Heatmap)
dev.off()
