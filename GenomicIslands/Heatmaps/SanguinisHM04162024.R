...
#islandcharacterization <- read.delim("~/Desktop/GenomicIslands/ByWhole/03112024-SanguinisCharacterization.txt", header = TRUE, check.names = FALSE)
islandcharacterization <- read.delim("~/Desktop/GenomicIslands/ByWhole/Sanguinis_ontologysummary_04162024.txt", header = TRUE, check.names = FALSE)
...
write_tsv(selectedislandcharacterization_rowlabels, "~/Desktop/GenomicIslands/ByWhole/Sanguinis-04162024-sortedontologies.tsv")
...
pdf("~/Desktop/GenomicIslands/ByWhole/Sanguinis-04162024.pdf", width = 11, height = 8)
draw(Heatmap)
dev.off()
