#!/bin/bash
 ...
 #SBATCH --mem=200gb
 #SBATCH --account=one
 #SBATCH --output=/storage/group/LiberalArts/default/lsw132_collab/04_LabMembersFolders/AvaGabrys/MapDamage/DD04Out.txt
 #SBATCH --error=/storage/group/LiberalArts/default/lsw132_collab/04_LabMembersFolders/AvaGabrys/MapDamage/DD04Error.txt
